...
const bgcanvas = innerDoc.getElementById("bgcanvas");
const bgctx = bgcanvas.getContext("2d");
const canvas = innerDoc.getElementById("canvas");
const labelscanvas = innerDoc.getElementById("labelscanvas");
						...
						if (currentState.isSelected) {
							if (currentState.selectionEnd - currentState.selectionStart == 1) {
								if (i == currentState.selectionStart) {
									...
									innerDoc.getElementById("selectedPhiSlider").value = currentAngles[i][0];
									innerDoc.getElementById("selectedPsiSlider").value = currentAngles[i][1];
								}
							}
						}
					}
...
mainSVG.onload = function() {
	canvasWidth = innerDoc.getElementById('ramachandran_div').clientWidth;
	canvasHeight = innerDoc.getElementById('ramachandran_div').clientHeight;
