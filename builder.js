...
var newPhiVal = innerDoc.getElementById("newPhiVal");
var newPsiVal = innerDoc.getElementById("newPsiVal");
var newOmegaVal = innerDoc.getElementById("newOmegaVal");
var newPhi = parseInt(innerDoc.getElementById("newPhiSlider").defaultValue);
var newPsi = parseInt(innerDoc.getElementById("newPsiSlider").defaultValue);
var newOmega = parseInt(innerDoc.getElementById("newOmegaSlider").defaultValue);
newPhiVal.innerHTML = newPhi;
newPsiVal.innerHTML = newPsi;
newOmegaVal.innerHTML = newOmega;
var selectedPhiVal = innerDoc.getElementById("selectedPhiVal");
var selectedPsiVal = innerDoc.getElementById("selectedPsiVal");
var selectedOmegaVal = innerDoc.getElementById("selectedOmegaVal");

var newPhiValSlider = innerDoc.getElementById("newPhiSlider");
...
var newPsiValSlider = innerDoc.getElementById("newPsiSlider");
...
var newOmegaValSlider = innerDoc.getElementById("newOmegaSlider");
...
var selectedPhiValSlider = innerDoc.getElementById("selectedPhiSlider");

selectedPhiValSlider.oninput = function() {
	var commands = "";
	const currentState = { ...textSelectionStorage.get(innerDoc.getElementById("sequence")) };
	...
	const checkedRadio = innerDoc.querySelector('input[name="style"]:checked').value;
...
var selectedPsiValSlider = innerDoc.getElementById("selectedPsiSlider");
...
var selectedOmegaValSlider = innerDoc.getElementById("selectedOmegaSlider");
...
function getPlanesCommands() {
	...
	const checkedRadio = innerDoc.querySelector('input[name="anglePlanes"]:checked').value;
...
function getBondsCommands() {
	...
	const checkedRadio = innerDoc.querySelector('input[name="angleBonds"]:checked').value;
...
function clashesChange() {
	const checkedRadio = innerDoc.querySelector('input[name="clashes"]:checked').value;
	switch (checkedRadio) {
		case 'true':
			clashes = true;
		break;
...
function labelsChange() {
	const checkedRadio = innerDoc.querySelector('input[name="labels"]:checked').value;
	switch (checkedRadio) {
		case 'true':
...
function styleChange() {
	...
	switch (checkedRadio) {
		case 'ballstick':
			innerDoc.getElementById("clashesTrue").removeAttribute("disabled");
			innerDoc.getElementById("clashesFalse").removeAttribute("disabled");
		break;
		case 'cartoon':
			innerDoc.getElementById("clashesTrue").setAttribute("disabled","disabled");
			innerDoc.getElementById("clashesFalse").setAttribute("disabled","disabled");
			innerDoc.getElementById("clashesTrue").checked = false;
			innerDoc.getElementById("clashesFalse").checked = true;
			clashes = false;
		break;
		default:
	}
...
function sequenceInitialise() {
	...
	var changedSeq = null;
	var moveAngles = false;
	const startSequence = innerDoc.getElementById("sequence").defaultValue;
...
function logTextDeselection(evt) {
  ...
  innerDoc.getElementById("selectedAngles").style.display = "none";
  innerDoc.getElementById("selectedOmegaAngle").style.display = "none";
  innerDoc.getElementById("phiButton").setAttribute("disabled","disabled");
  innerDoc.getElementById("psiButton").setAttribute("disabled","disabled");
  innerDoc.getElementById("omegaButton").setAttribute("disabled","disabled");
...
function logTextSelection(evt) {
  ...
  innerDoc.getElementById("selectedAngles").style.display = "none";
  innerDoc.getElementById("selectedOmegaAngle").style.display = "none";
  innerDoc.getElementById("phiButton").removeAttribute("disabled");
  innerDoc.getElementById("psiButton").removeAttribute("disabled");
  innerDoc.getElementById("omegaButton").removeAttribute("disabled");
  
  if (currentSelection.length == 1) {
	innerDoc.getElementById("selectedAngles").style.display = "block";
	innerDoc.getElementById("selectedPhiSlider").value = currentAngles[selectionStart][0];
	innerDoc.getElementById("selectedPsiSlider").value = currentAngles[selectionStart][1];
	...
	innerDoc.getElementById("selectedOmegaAngle").style.display = "block";
	innerDoc.getElementById("selectedOmegaSlider").value = currentAngles[selectionStart][2];
...
function mainTextControl() {
  const textControl = innerDoc.getElementById("sequence");
